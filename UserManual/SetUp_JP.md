...
https://github.com/grevo-vn/Work-From-Home/tree/master/GoogleAppsScript
```
...
クリックします。これで現在のワークスペースにアプリが追加されます。
```
**4. WebHook** を登録する
...
設定画面はメニュー内「Features」にある「Incoming Webhook」で表示できます。
```
